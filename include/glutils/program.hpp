...
class ProgramHandle : public Handle
{
    using Handle::Handle;
public:
    static auto create() -> ProgramHandle;
    ...
    void attachShader(ShaderHandle shader) const;
    ...
    void detachShader(ShaderHandle shader) const;
...
template<> const ProgramHandle::GLProgramUniformFunctions<float>          ProgramHandle::s_program_uniform_functions<float>;
template<> const ProgramHandle::GLProgramUniformFunctions<double>         ProgramHandle::s_program_uniform_functions<double>;
template<> const ProgramHandle::GLProgramUniformFunctions<int>            ProgramHandle::s_program_uniform_functions<int>;
template<> const ProgramHandle::GLProgramUniformFunctions<unsigned int>   ProgramHandle::s_program_uniform_functions<unsigned int>;

template<> const ProgramHandle::GLProgramUniformvFunctions<float>         ProgramHandle::s_program_uniform_v_functions<float>;
template<> const ProgramHandle::GLProgramUniformvFunctions<double>        ProgramHandle::s_program_uniform_v_functions<double>;
template<> const ProgramHandle::GLProgramUniformvFunctions<int>           ProgramHandle::s_program_uniform_v_functions<int>;
template<> const ProgramHandle::GLProgramUniformvFunctions<unsigned int>  ProgramHandle::s_program_uniform_v_functions<unsigned int>;

template<> const ProgramHandle::GLProgramUniformMatrixFunctions<float>    ProgramHandle::s_program_uniform_matrix_functions<float>;
template<> const ProgramHandle::GLProgramUniformMatrixFunctions<double>   ProgramHandle::s_program_uniform_matrix_functions<double>;

template<auto N, class T, auto Q>
constexpr auto ProgramHandle::s_glProgramUniform<glm::vec<N, T, Q>> =
...
template<auto N, class T, auto Q>
constexpr auto ProgramHandle::s_glProgramUniformv<glm::vec<N, T, Q>> =
...
using Program = Object<ProgramHandle>;
